...
favoriteMovie.quote = "Cause if we can't protect the Earth, you can be damn sure we'll avenge it."
...
console.log("My favorite movie is " + favoriteMovie.name + " The genre is " + favoriteMovie.genre + " I rate it " + favoriteMovie.rating + " stars" + " my favorite quote is " + favoriteMovie.quote)
